...
try {
  const m = await import("../extra/customer-notes.ts");
...
const cmd = new Command()
  ...
  .command("list", "List Customer Notes.\n\nhttps://docs.lana.dev/commerce/query/customerNotes")
  ...
  .action(async (opts) => {
    ...
    let req = request(ctx, "GET:customer_notes.json")
  ...
  .command("get [...ids]", "Get one or multiple Customer Notes.\n\nhttps://docs.lana.dev/commerce/query/customerNotes")
  .option("--customer-id <string:string>", "Unique customer identifier.", { required: true })
  .option("--shop-id <string:string>", "Unique shop identifier.")
  .option("--format <format>", "Format the output in a specific way.", {
    default: "table",
  ...
  .command("delete <...ids>", "Delete one or multiple Customer Notes.\n\nhttps://docs.lana.dev/commerce/mutation/customerNotesDelete")
  .option("--customer-id <string:string>", "Unique customer identifier.", { required: true })
  .option("--shop-id <string:string>", "Unique shop identifier.")
  .action(async (opts, ...ids) => {
    const ctx = getRequestContext();
    await updateAllCacheEntries(ctx, opts.shopId || getConfigValue("shop_id"));
    let req = request(ctx, "DELETE:customer_notes.json")
    req = req.ids(ids)
    if (opts.customerId !== undefined) req = req.customer_id(opts.customerId)
    req = req.shop_id(opts.shopId || getConfigValue("shop_id"))
  ...
  .command("create", "Create one or multiple Customer Notes.\n\nhttps://docs.lana.dev/commerce/mutation/customerNotesCreate")
  .option("--customer-id <string:string>", "Unique customer identifier.", { required: true })
  .option("--shop-id <string:string>", "Unique shop identifier.")
  ...
  .action(async (opts) => {
    const ctx = getRequestContext();
    await updateAllCacheEntries(ctx, opts.shopId || getConfigValue("shop_id"));
    let req = request(ctx, "POST:customer_notes.json");
    if (opts.customerId !== undefined) req = req.customer_id(opts.customerId)
    req = req.shop_id(opts.shopId || getConfigValue("shop_id"))
  ...
  .command("modify <ids...>", "Modify one or multiple Customer Notes.\n\nhttps://docs.lana.dev/commerce/mutation/customerNotesModify")
  .option("--customer-id <string:string>", "Unique customer identifier.", { required: true })
  .option("--shop-id <string:string>", "Unique shop identifier.")
  ...
  .action(async (opts, ...ids) => {
    const ctx = getRequestContext();
    await updateAllCacheEntries(ctx, opts.shopId || getConfigValue("shop_id"));
    let req = request(ctx, "POST:customer_notes.json").ids(ids);
    if (opts.customerId !== undefined) req = req.customer_id(opts.customerId)
    req = req.shop_id(opts.shopId || getConfigValue("shop_id"))
    req = req.data(assembleInputData(opts, true, {
      text: "text",
